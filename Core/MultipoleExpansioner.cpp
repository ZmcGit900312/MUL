...
Core::AIMAssist::MultipoleExpansioner::~MultipoleExpansioner()
{
	Index.clear();
	Index.shrink_to_fit();
}

void MultipoleExpansioner::Reset(const ImpConfiguration & configuration, size_t layer[3], double const w7[7])
{
...
//void Core::AIMAssist::VirtualME::Reset(const ImpConfiguration & configuration, size_t layer[3], const double w7[7])
//{
//	_boxStart = configuration.Box[0];
//	_dimension = configuration.Dimension;
//	_interval = configuration.Interval;
