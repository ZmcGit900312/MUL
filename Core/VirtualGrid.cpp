...
//	MKL_LONG layer[3]={ _layerElementSize.x() ,_layerElementSize.y(), _layerElementSize.z() };
//
...
//	}
//
//	const dcomplex tempx = field.gamax.transpose()*(green*source.gamax);
//	const dcomplex tempy = field.gamay.transpose()*(green*source.gamay);
//	const dcomplex tempz = field.gamaz.transpose()*(green*source.gamaz);
//	const dcomplex tempd = field.gamad.transpose()*(green*source.gamad);
//
